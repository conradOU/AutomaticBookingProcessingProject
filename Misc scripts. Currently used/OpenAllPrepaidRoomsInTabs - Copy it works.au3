	...
	While 1
		...
		Switch GUIGetMsg()
			...
			Case $idButton_Continue
				...
				Exit
			Case $idCheckbox101
				(_IsChecked($idCheckbox101)) ? (_ArrayAdd($array, 1)) : (_ArrayDelete($array, _ArraySearch($array, 1)))

			Case $idCheckbox102
				(_IsChecked($idCheckbox102)) ? (_ArrayAdd($array, 2)) : (_ArrayDelete($array, _ArraySearch($array, 2)))

			Case $idCheckbox103
				(_IsChecked($idCheckbox103)) ? (_ArrayAdd($array, 3)) : (_ArrayDelete($array, _ArraySearch($array, 3)))

			Case $idCheckbox104
				(_IsChecked($idCheckbox104)) ? (_ArrayAdd($array, 4)) : (_ArrayDelete($array, _ArraySearch($array, 4)))

			Case $idCheckbox105
				(_IsChecked($idCheckbox105)) ? (_ArrayAdd($array, 5)) : (_ArrayDelete($array, _ArraySearch($array, 5)))

			Case $idCheckbox106
				(_IsChecked($idCheckbox106)) ? (_ArrayAdd($array, 6)) : (_ArrayDelete($array, _ArraySearch($array, 6)))

			Case $idCheckbox107
				(_IsChecked($idCheckbox107)) ? (_ArrayAdd($array, 7)) : (_ArrayDelete($array, _ArraySearch($array, 7)))

			Case $idCheckbox108
				(_IsChecked($idCheckbox108)) ? (_ArrayAdd($array, 8)) : (_ArrayDelete($array, _ArraySearch($array, 8)))

			Case $idCheckbox109
				(_IsChecked($idCheckbox109)) ? (_ArrayAdd($array, 9)) : (_ArrayDelete($array, _ArraySearch($array, 9)))

			Case $idCheckbox110
				(_IsChecked($idCheckbox110)) ? (_ArrayAdd($array, 10)) : (_ArrayDelete($array, _ArraySearch($array, 10)))

			Case $idCheckbox111
				(_IsChecked($idCheckbox111)) ? (_ArrayAdd($array, 11)) : (_ArrayDelete($array, _ArraySearch($array, 11)))

			Case $idCheckbox112
				(_IsChecked($idCheckbox112)) ? (_ArrayAdd($array, 12)) : (_ArrayDelete($array, _ArraySearch($array, 12)))

			Case $idCheckbox113
				(_IsChecked($idCheckbox113)) ? (_ArrayAdd($array, 13)) : (_ArrayDelete($array, _ArraySearch($array, 13)))

			Case $idCheckbox114
				(_IsChecked($idCheckbox114)) ? (_ArrayAdd($array, 14)) : (_ArrayDelete($array, _ArraySearch($array, 14)))

			Case $idCheckbox115
				(_IsChecked($idCheckbox115)) ? (_ArrayAdd($array, 15)) : (_ArrayDelete($array, _ArraySearch($array, 15)))

			Case $idCheckbox116
				(_IsChecked($idCheckbox116)) ? (_ArrayAdd($array, 16)) : (_ArrayDelete($array, _ArraySearch($array, 16)))

			Case $idCheckbox117
				(_IsChecked($idCheckbox117)) ? (_ArrayAdd($array, 17)) : (_ArrayDelete($array, _ArraySearch($array, 17)))

			Case $idCheckbox118
				(_IsChecked($idCheckbox118)) ? (_ArrayAdd($array, 18)) : (_ArrayDelete($array, _ArraySearch($array, 18)))

			Case $idCheckbox119
				(_IsChecked($idCheckbox119)) ? (_ArrayAdd($array, 19)) : (_ArrayDelete($array, _ArraySearch($array, 19)))

				;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
			Case $idCheckbox20
				(_IsChecked($idCheckbox20)) ? (_ArrayAdd($array, 20)) : (_ArrayDelete($array, _ArraySearch($array, 20)))

			Case $idCheckbox21
				(_IsChecked($idCheckbox21)) ? (_ArrayAdd($array, 21)) : (_ArrayDelete($array, _ArraySearch($array, 21)))

			Case $idCheckbox22
				(_IsChecked($idCheckbox22)) ? (_ArrayAdd($array, 22)) : (_ArrayDelete($array, _ArraySearch($array, 22)))

			Case $idCheckbox23
				(_IsChecked($idCheckbox23)) ? (_ArrayAdd($array, 23)) : (_ArrayDelete($array, _ArraySearch($array, 23)))

			Case $idCheckbox24
				(_IsChecked($idCheckbox24)) ? (_ArrayAdd($array, 24)) : (_ArrayDelete($array, _ArraySearch($array, 24)))

			Case $idCheckbox25
				(_IsChecked($idCheckbox25)) ? (_ArrayAdd($array, 25)) : (_ArrayDelete($array, _ArraySearch($array, 25)))

			Case $idCheckbox26
				(_IsChecked($idCheckbox26)) ? (_ArrayAdd($array, 26)) : (_ArrayDelete($array, _ArraySearch($array, 26)))

			Case $idCheckbox27
				(_IsChecked($idCheckbox27)) ? (_ArrayAdd($array, 27)) : (_ArrayDelete($array, _ArraySearch($array, 27)))

			Case $idCheckbox28
				(_IsChecked($idCheckbox28)) ? (_ArrayAdd($array, 28)) : (_ArrayDelete($array, _ArraySearch($array, 28)))

			Case $idCheckbox29
				(_IsChecked($idCheckbox29)) ? (_ArrayAdd($array, 29)) : (_ArrayDelete($array, _ArraySearch($array, 29)))

				;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
			Case $idCheckbox30
				(_IsChecked($idCheckbox30)) ? (_ArrayAdd($array, 30)) : (_ArrayDelete($array, _ArraySearch($array, 30)))

			Case $idCheckbox31
				(_IsChecked($idCheckbox31)) ? (_ArrayAdd($array, 31)) : (_ArrayDelete($array, _ArraySearch($array, 31)))
